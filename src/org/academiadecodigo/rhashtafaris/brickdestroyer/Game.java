package org.academiadecodigo.rhashtafaris.brickdestroyer;


import org.academiadecodigo.rhashtafaris.brickdestroyer.gameobjects.Ball;
import org.academiadecodigo.rhashtafaris.brickdestroyer.gameobjects.Brick;
import org.academiadecodigo.rhashtafaris.brickdestroyer.gameobjects.Table;
        ...
        while (true) {
            ...
            while (youMove) {
                ...
                if (collision.isBallCollision()) {
                    ...
                    System.out.println(ball.getLogicPosition().getCol() + " | " + ball.getLogicPosition().getRow());
                    continue;
                }
                ...
                if (collision.isCrashedWalls()) {
                    ball.setDirection(ball.getDirection().oppositeDirectionWalls());
                    continue;
                }
